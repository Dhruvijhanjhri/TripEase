...
urlpatterns = [
    path("", views.package_search, name="search"),
    path("detail/<int:package_id>/", views.package_detail, name="detail"),
    path("book/<int:package_id>/", views.package_booking, name="book"),
